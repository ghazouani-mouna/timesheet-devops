...
public class RestControlEntreprise {
	...
	@ResponseBody
	public int ajouterEntreprise(@RequestBody EntrepriseDto entDto) {
		Entreprise ent=modelMapper.map(entDto,Entreprise.class);
		
	
		return ientrepriseservice.ajouterEntreprise(ent);
	}
